	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Editar Cidade'); ?></h1>
			</div>
		</div>
	</div>
					...
					<div class="panel-heading">Ações</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
									<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete'), array('action' => 'delete', $this->Form->value('Cidade.id')), array('escape' => false), __('Deseja Deletar a cidade # %s?', $this->Form->value('Cidade.id'))); ?></li>
									<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;Listagem Cidades'), array('action' => 'index'), array('escape' => false)); ?></li>
