				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Edit Estabelecimento'), array('action' => 'edit', $estabelecimento['Estabelecimento']['id']), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete Estabelecimento'), array('action' => 'delete', $estabelecimento['Estabelecimento']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $estabelecimento['Estabelecimento']['id'])); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Estabelecimentos'), array('action' => 'index'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Estabelecimento'), array('action' => 'add'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Cidades'), array('controller' => 'cidades', 'action' => 'index'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Cidade'), array('controller' => 'cidades', 'action' => 'add'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Pedidos'), array('controller' => 'pedidos', 'action' => 'index'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Pedido'), array('controller' => 'pedidos', 'action' => 'add'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Pedidos Itens'), array('controller' => 'pedidos_itens', 'action' => 'index'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Pedidos Iten'), array('controller' => 'pedidos_itens', 'action' => 'add'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Produtos'), array('controller' => 'produtos', 'action' => 'index'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Produto'), array('controller' => 'produtos', 'action' => 'add'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Produtos Fotos'), array('controller' => 'produtos_fotos', 'action' => 'index'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Produtos Foto'), array('controller' => 'produtos_fotos', 'action' => 'add'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Produtos Valores'), array('controller' => 'produtos_valores', 'action' => 'index'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Produtos Valore'), array('controller' => 'produtos_valores', 'action' => 'add'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Tamanhos'), array('controller' => 'tamanhos', 'action' => 'index'), array('escape' => false)); ?>
							</li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Tamanho'), array('controller' => 'tamanhos', 'action' => 'add'), array('escape' => false)); ?>
							</li>
						</ul>
					</div>
					<!-- end body -->
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<tbody>
					<tr>
						...
						<td><?php echo h($estabelecimento['Estabelecimento']['id']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Nome Fantasia'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['nome_fantasia']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Razao Social'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['razao_social']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Cpf'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['cpf']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Cnpj'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['cnpj']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Endereco'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['endereco']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Cidade'); ?>
						</th>
						<td><?php echo $this->Html->link($estabelecimento['Cidade']['id'], array('controller' => 'cidades', 'action' => 'view', $estabelecimento['Cidade']['id'])); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Bairro'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['bairro']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Cep'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['cep']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Ativo'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['ativo']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Aberto'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['aberto']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Empresa Destaque'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['empresa_destaque']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Email'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['email']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Senha'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['senha']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Created'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['created']); ?>
							&nbsp;</td>
					</tr>
					<tr>
						<th><?php echo __('Modified'); ?>
						</th>
						<td><?php echo h($estabelecimento['Estabelecimento']['modified']); ?>
							&nbsp;</td>
					</tr>
				</tbody>
			</table>
		...
		<table cellpadding="0" cellspacing="0" class="table table-striped">
			...
			<?php foreach ($estabelecimento['Pedido'] as $pedido): ?>
				<tr>
					...
					<td class="actions"><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-search"></span>'), array('controller' => 'pedidos', 'action' => 'view', $pedido['id']), array('escape' => false)); ?>
...
<div class="related row">
	<div class="col-md-12">
		<h3>
		<?php echo __('Related Pedidos Itens'); ?>
		</h3>
		...
		<table cellpadding="0" cellspacing="0" class="table table-striped">
			...
			<?php foreach ($estabelecimento['PedidosIten'] as $pedidosIten): ?>
				<tr>
					...
					<td class="actions"><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-search"></span>'), array('controller' => 'pedidos_itens', 'action' => 'view', $pedidosIten['id']), array('escape' => false)); ?>
		...
		<table cellpadding="0" cellspacing="0" class="table table-striped">
			...
			<?php foreach ($estabelecimento['Produto'] as $produto): ?>
				<tr>
					...
					<td class="actions"><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-search"></span>'), array('controller' => 'produtos', 'action' => 'view', $produto['id']), array('escape' => false)); ?>
...
<div class="related row">
	<div class="col-md-12">
		<h3>
		<?php echo __('Related Produtos Fotos'); ?>
		</h3>
		...
		<table cellpadding="0" cellspacing="0" class="table table-striped">
			...
			<?php foreach ($estabelecimento['ProdutosFoto'] as $produtosFoto): ?>
				<tr>
					...
					<td class="actions"><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-search"></span>'), array('controller' => 'produtos_fotos', 'action' => 'view', $produtosFoto['id']), array('escape' => false)); ?>
...
<div class="related row">
	<div class="col-md-12">
		<h3>
		<?php echo __('Related Produtos Valores'); ?>
		</h3>
		...
		<table cellpadding="0" cellspacing="0" class="table table-striped">
			...
			<?php foreach ($estabelecimento['ProdutosValore'] as $produtosValore): ?>
				<tr>
					...
					<td class="actions"><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-search"></span>'), array('controller' => 'produtos_valores', 'action' => 'view', $produtosValore['id']), array('escape' => false)); ?>
		...
		<table cellpadding="0" cellspacing="0" class="table table-striped">
			...
			<?php foreach ($estabelecimento['Tamanho'] as $tamanho): ?>
				<tr>
					...
					<td class="actions"><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-search"></span>'), array('controller' => 'tamanhos', 'action' => 'view', $tamanho['id']), array('escape' => false)); ?>
