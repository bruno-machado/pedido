	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Tamanho'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('qtd_sabores'); ?></th>
				...
				<?php foreach ($tamanhos as $tamanho): ?>
					<tr>
						<td><?php echo h($tamanho['Tamanho']['id']); ?>&nbsp;</td>
						<td><?php echo h($tamanho['Tamanho']['descricao']); ?>&nbsp;</td>
						<td><?php echo h($tamanho['Tamanho']['qtd_sabores']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($tamanho['Estabelecimento']['nome_fantasia'], array('controller' => 'estabelecimentos', 'action' => 'view', $tamanho['Estabelecimento']['id'])); ?>
						...
						<td><?php echo h($tamanho['Tamanho']['created']); ?>&nbsp;</td>
						<td><?php echo h($tamanho['Tamanho']['modified']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $tamanho['Tamanho']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $tamanho['Tamanho']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $tamanho['Tamanho']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $tamanho['Tamanho']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
