					...
					<div class="panel-heading">Ações</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								...
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;Listagem Estados'), array('controller' => 'estados', 'action' => 'index'), array('escape' => false)); ?> </li>
							</ul>
						</div><!-- end body -->
				</div><!-- end panel -->
			</div><!-- end actions -->
		...
		<div class="col-md-9">
			...
			<?php echo $this->Html->link($cidade['Estado']['nome_estado'], array('controller' => 'estados', 'action' => 'view', $cidade['Estado']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $cidade['Cidade']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $cidade['Cidade']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
