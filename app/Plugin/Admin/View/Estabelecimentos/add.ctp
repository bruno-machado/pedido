...
jQuery(function($){
	   $("#EstabelecimentoCpf").mask("999999999-99");
	   $("#EstabelecimentoCnpj").mask("99.999.999/9999-99");
	});
</script>
<div class="estabelecimentos form">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1>
				<?php echo __('Add Estabelecimento'); ?>
				</h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							...
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;List Estabelecimentos'), array('action' => 'index'), array('escape' => false)); ?>
							</li>
		...
		<?php echo $this->Form->create('Estabelecimento', array('role' => 'form')); ?>
			...
			<div class="form-group">
			<?php echo $this->Form->input('cpf', array('class' => 'form-control', 'placeholder' => 'XXXXXXXXX-XX'));?>
			</div>
			<div class="form-group">
			<?php echo $this->Form->input('cnpj', array('class' => 'form-control', 'placeholder' => 'XX.XXX.XXX/XXXX-XX'));?>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
			<?php echo $this->Form->input('ativo', array('class' => 'form-control','options' => array('1' => '1', '2' => '2')));?>
			</div>
			<div class="form-group">
			<?php echo $this->Form->input('aberto', array('class' => 'form-control','options' => array('1' => '1', '2' => '2')));?>
			</div>
			<div class="form-group">
			<?php echo $this->Form->input('empresa_destaque', array('class' => 'form-control','options' => array('1' => '1', '2' => '2')));?>
			</div>
			<div class="form-group">
