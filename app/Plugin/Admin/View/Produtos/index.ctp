		...
		<div class="col-md-9">
			...
			<?php echo $this->Html->link($produto['Categoria']['descricao'], array('controller' => 'categorias', 'action' => 'view', $produto['Categoria']['id'])); ?>
						...
						<td class="actions">
                            ...
                            <?php echo $this->Html->link('<span class="glyphicon glyphicon-camera"></span>', array('controller' => 'produtosfotos', 'action' => "index?idproduto=".$produto['Produto']['id']), array('escape' => false)); ?>
